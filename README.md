...
- Архитектура: монолитное приложение, в котором вся обработка запросов, бизнес-логика, работа с данными выполняется в рамках одного приложения. Есть отдельно стоящий REST сервис, который, предоставляет данные температуры с сенсоров
...
- Возможны ошибки эксплуатирования: Текущее решение позволяет пользвателю самостоятельно удалять датчики и редактировать их. Тем самым он может неосознанно нарушить целостность настроенной системы - никто не отменял человеческий фактор
